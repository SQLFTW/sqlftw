...
class TokenType extends IntSet
{
    ...
    /** Any comment */
    public const COMMENT = self::BLOCK_COMMENT | self::LINE_COMMENT;

    /** Any name (quoted string or unquoted string other than a keyword) */
    public const NAME = self::UNQUOTED_NAME | self::QUOTED_NAME | self::AT_VARIABLE;

    /** Any value (string, number, boolean...) */
    public const VALUE = self::NUMBER | self::STRING | self::BIT_STRING | self::UUID;
