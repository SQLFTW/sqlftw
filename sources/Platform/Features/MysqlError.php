...
// spell-check-ignore: AMBIGOUS AWS BADRETURN BADSELECT BADSTATEMENT BLOCKHOLE BUFPOOL CHECKREAD COLUMNACCESS CTX CURSHNDLR DBACCESS DBS DISPLAYWIDTH DML DOCID DOESNT DONT DUP DUPID EMFILE ENDIANESS ERRMSG FCNTL FCT FIELDLENGTH FIELDNAME FILSORT FPARSER FTS GEOJSON GIS GNO HASHCHK HNDLR INEXISTENT INPROGRESS INSERTABLE INVAL IPSOCK ISNT KDF KEYFILE KEYNAME KMS LILABEL MGMT MULTIUPDATE NCOLLATIONS NISAMCHK NONEXISTING NONPARTITIONED NONTRANS NONUNIQ NONUPD NONUPDATEABLE NOPK NORETURN NORETURNEND NOTA NYI OUTOFMEMORY PARAMCOUNT PASSWD PERFSCHEMA PLUGGABLE PROCACCESS RBDEADLOCK RBROLLBACK RBTIMEOUT READLOCK REORG REPL REPREPARE RESIZE RETSET RLI RMERR RMFAIL ROWSIZE RUNTIME SBR SORTMEMORY SPKEYS SPLITTABLE SPVAR SQLTHREAD SRIDS SROUTINE STRUCT SUBPART SUBSELECT SYSVAR TABLEACCESS TABLENAME TEXTFILE THD TMPTABLE TRG TRXS UNINIT UNIQ UNSUPORTED UPG VARCOND VER VTOKEN WD WILDCARD WSAS XAER
