...
class FeaturesMysql57 extends PlatformFeatures
{
    ...
    public const OPERATOR_KEYWORDS = FeaturesMysql56::OPERATOR_KEYWORDS;

    public const OPERATORS = FeaturesMysql55::OPERATORS + [
        Operator::JSON_EXTRACT, // new in 5.7
    ];

    public const TYPES = FeaturesMysql56::TYPES;

    public const TYPE_ALIASES = FeaturesMysql56::TYPE_ALIASES;
    ...
    public const BUILT_IN_FUNCTIONS = [
        ...
        BuiltInFunction::JSON_ARRAY, // new in 5.7
        BuiltInFunction::JSON_ARRAY_APPEND, // new in 5.7
        BuiltInFunction::JSON_ARRAY_INSERT, // new in 5.7
        BuiltInFunction::JSON_CONTAINS, // new in 5.7
        BuiltInFunction::JSON_CONTAINS_PATH, // new in 5.7
        BuiltInFunction::JSON_DEPTH, // new in 5.7
        BuiltInFunction::JSON_EXTRACT, // new in 5.7
        BuiltInFunction::JSON_INSERT, // new in 5.7
        BuiltInFunction::JSON_KEYS, // new in 5.7
        BuiltInFunction::JSON_LENGTH, // new in 5.7
        BuiltInFunction::JSON_MERGE, // new in 5.7
        BuiltInFunction::JSON_OBJECT, // new in 5.7
        BuiltInFunction::JSON_QUOTE, // new in 5.7
        BuiltInFunction::JSON_REMOVE, // new in 5.7
        BuiltInFunction::JSON_REPLACE, // new in 5.7
        BuiltInFunction::JSON_SEARCH, // new in 5.7
        BuiltInFunction::JSON_SET, // new in 5.7
        BuiltInFunction::JSON_TYPE, // new in 5.7
        BuiltInFunction::JSON_UNQUOTE, // new in 5.7
        BuiltInFunction::JSON_VALID, // new in 5.7
