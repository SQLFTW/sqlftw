...
Assert::parse("GRANT role1 TO usr2@host2");
Assert::parse("GRANT role1, role2 TO usr1@host1");
Assert::parse("GRANT role1 TO usr2@host2, usr3@host3");
Assert::parse("GRANT role1 TO usr2@host2 WITH ADMIN OPTION");
