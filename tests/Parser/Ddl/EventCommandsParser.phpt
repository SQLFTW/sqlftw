...
// [DO event_body]
Assert::parse("ALTER EVENT evt1 DO SELECT 1");
...
//   [COMMENT 'comment']
//   DO event_body
Assert::parse("CREATE EVENT evt1 ON SCHEDULE EVERY 6 HOUR DO SELECT 1");
Assert::parse("CREATE DEFINER = usr1@host1 EVENT evt1 ON SCHEDULE EVERY 6 HOUR DO SELECT 1");
Assert::parse("CREATE DEFINER = CURRENT_USER EVENT evt1 ON SCHEDULE EVERY 6 HOUR DO SELECT 1");
Assert::parse(
    "CREATE DEFINER CURRENT_USER EVENT evt1 ON SCHEDULE EVERY 6 HOUR DO SELECT 1",
    "CREATE DEFINER = CURRENT_USER EVENT evt1 ON SCHEDULE EVERY 6 HOUR DO SELECT 1" // [=]
);
Assert::parse("CREATE EVENT IF NOT EXISTS evt1 ON SCHEDULE EVERY 6 HOUR DO SELECT 1");
Assert::parse("CREATE EVENT evt1 ON SCHEDULE EVERY 6 HOUR DO SELECT 1");
Assert::parse("CREATE EVENT evt1 ON SCHEDULE EVERY 6 HOUR ON COMPLETION PRESERVE DO SELECT 1");
Assert::parse("CREATE EVENT evt1 ON SCHEDULE EVERY 6 HOUR ON COMPLETION NOT PRESERVE DO SELECT 1");
Assert::parse("CREATE EVENT evt1 ON SCHEDULE EVERY 6 HOUR ENABLE DO SELECT 1");
Assert::parse("CREATE EVENT evt1 ON SCHEDULE EVERY 6 HOUR DISABLE DO SELECT 1");
Assert::parse("CREATE EVENT evt1 ON SCHEDULE EVERY 6 HOUR DISABLE ON SLAVE DO SELECT 1");
Assert::parse("CREATE EVENT evt1 ON SCHEDULE EVERY 6 HOUR COMMENT 'com1' DO SELECT 1");
