...
Assert::parse("CREATE FUNCTION func1() RETURNS INT COMMENT 'com1' BEGIN RETURN 1 END");
Assert::parse("CREATE FUNCTION func1() RETURNS INT LANGUAGE SQL BEGIN RETURN 1 END");
Assert::parse("CREATE FUNCTION func1() RETURNS INT CONTAINS SQL BEGIN RETURN 1 END");
Assert::parse("CREATE FUNCTION func1() RETURNS INT NO SQL BEGIN RETURN 1 END");
Assert::parse("CREATE FUNCTION func1() RETURNS INT READS SQL DATA BEGIN RETURN 1 END");
Assert::parse("CREATE FUNCTION func1() RETURNS INT MODIFIES SQL DATA BEGIN RETURN 1 END");
Assert::parse("CREATE FUNCTION func1() RETURNS INT SQL SECURITY DEFINER BEGIN RETURN 1 END");
Assert::parse("CREATE FUNCTION func1() RETURNS INT SQL SECURITY INVOKER BEGIN RETURN 1 END");

Assert::parse("CREATE FUNCTION func1() RETURNS INT COMMENT 'com1' LANGUAGE SQL BEGIN RETURN 1 END");
Assert::parse(
...
Assert::parse("CREATE PROCEDURE proc1() COMMENT 'com1' BEGIN SELECT 1 END");
Assert::parse("CREATE PROCEDURE proc1() LANGUAGE SQL BEGIN SELECT 1 END");
Assert::parse("CREATE PROCEDURE proc1() CONTAINS SQL BEGIN SELECT 1 END");
Assert::parse("CREATE PROCEDURE proc1() NO SQL BEGIN SELECT 1 END");
Assert::parse("CREATE PROCEDURE proc1() READS SQL DATA BEGIN SELECT 1 END");
Assert::parse("CREATE PROCEDURE proc1() MODIFIES SQL DATA BEGIN SELECT 1 END");
Assert::parse("CREATE PROCEDURE proc1() SQL SECURITY DEFINER BEGIN SELECT 1 END");
Assert::parse("CREATE PROCEDURE proc1() SQL SECURITY INVOKER BEGIN SELECT 1 END");

Assert::parse("CREATE PROCEDURE proc1() COMMENT 'com1' LANGUAGE SQL BEGIN SELECT 1 END");
Assert::parse(
