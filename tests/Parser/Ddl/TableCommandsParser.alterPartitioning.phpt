...
Assert::parse("ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 COMMENT = 'foo')");
Assert::parse(
    "ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 COMMENT 'foo')",
    "ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 COMMENT = 'foo')"
);

// [DATA DIRECTORY [=] 'data_dir']
Assert::parse("ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 DATA DIRECTORY = 'foo')");
Assert::parse(
    "ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 DATA DIRECTORY 'foo')",
    "ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 DATA DIRECTORY = 'foo')"
);

// [INDEX DIRECTORY [=] 'index_dir']
Assert::parse("ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 INDEX DIRECTORY = 'foo')");
Assert::parse(
    "ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 INDEX DIRECTORY 'foo')",
    "ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 INDEX DIRECTORY = 'foo')"
);
...
Assert::parse("ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 TABLESPACE = 'foo')");
Assert::parse(
    "ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 TABLESPACE 'foo')",
    "ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 TABLESPACE = 'foo')"
);
...
// [COMMENT [=] 'comment_text' ]
Assert::parse("ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 (SUBPARTITION sub1 COMMENT = 'foo'))");
Assert::parse(
    "ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 (SUBPARTITION sub1 COMMENT 'foo'))",
    "ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 (SUBPARTITION sub1 COMMENT = 'foo'))"
);

// [DATA DIRECTORY [=] 'data_dir']
Assert::parse("ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 (SUBPARTITION sub1 DATA DIRECTORY = 'foo'))");
Assert::parse(
    "ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 (SUBPARTITION sub1 DATA DIRECTORY 'foo'))",
    "ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 (SUBPARTITION sub1 DATA DIRECTORY = 'foo'))"
);

// [INDEX DIRECTORY [=] 'index_dir']
Assert::parse("ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 (SUBPARTITION sub1 INDEX DIRECTORY = 'foo'))");
Assert::parse(
    "ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 (SUBPARTITION sub1 INDEX DIRECTORY 'foo'))",
    "ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 (SUBPARTITION sub1 INDEX DIRECTORY = 'foo'))"
);
...
// [TABLESPACE [=] tablespace_name]
Assert::parse("ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 (SUBPARTITION sub1 TABLESPACE = 'foo'))");
Assert::parse(
    "ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 (SUBPARTITION sub1 TABLESPACE 'foo'))",
    "ALTER TABLE tbl1 ADD PARTITION (PARTITION part1 (SUBPARTITION sub1 TABLESPACE = 'foo'))"
);
