...
Assert::parseSerialize("SELECT col1, col2 FROM tbl1, tbl2 GROUP BY col3 IS NULL, col4 - 10 ASC, col5 < 1 DESC"); // todo: problem with "col1 -10" (parsed as negative number)
