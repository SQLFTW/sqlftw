...
Assert::token($tokens[1], T::BINARY_LITERAL, '0101', 1);
Assert::token($tokens[2], T::WHITESPACE, ' ', 7);

$tokens = Assert::tokens(' 0b0102 ', 3);
Assert::token($tokens[0], T::WHITESPACE, ' ', 0);
Assert::token($tokens[1], T::UNQUOTED_NAME, '0b0102', 1);
Assert::token($tokens[2], T::WHITESPACE, ' ', 7);
...
Assert::invalidToken($tokens[1], T::BINARY_LITERAL | T::INVALID, '~^Invalid binary literal~', 1);
...
Assert::token($tokens[0], T::WHITESPACE, ' ', 0);
Assert::token($tokens[1], T::HEXADECIMAL_LITERAL, '12ab', 1);
Assert::token($tokens[2], T::WHITESPACE, ' ', 7);

$tokens = Assert::tokens(' 0x12AG ', 3);
Assert::token($tokens[0], T::WHITESPACE, ' ', 0);
Assert::token($tokens[1], T::UNQUOTED_NAME, '0x12AG', 1);
Assert::token($tokens[2], T::WHITESPACE, ' ', 7);
...
Assert::invalidToken($tokens[1], T::HEXADECIMAL_LITERAL | T::INVALID, '~^Invalid hexadecimal literal~', 1);
