...
// type
Assert::same(BaseType::get(BaseType::BIGINT), $columns[0]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::INT), $columns[1]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::MEDIUMINT), $columns[2]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::SMALLINT), $columns[3]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::TINYINT), $columns[4]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::BIT), $columns[5]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::FLOAT), $columns[6]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::DOUBLE), $columns[7]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::DECIMAL), $columns[8]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::YEAR), $columns[9]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::DATE), $columns[10]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::DATETIME), $columns[11]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::TIME), $columns[12]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::TIMESTAMP), $columns[13]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::CHAR), $columns[14]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::VARCHAR), $columns[15]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::TINYTEXT), $columns[16]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::TEXT), $columns[17]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::MEDIUMTEXT), $columns[18]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::LONGTEXT), $columns[19]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::BINARY), $columns[20]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::VARBINARY), $columns[21]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::TINYBLOB), $columns[22]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::BLOB), $columns[23]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::MEDIUMBLOB), $columns[24]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::LONGBLOB), $columns[25]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::JSON), $columns[26]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::ENUM), $columns[27]->getType()->getBaseType());
Assert::same(BaseType::get(BaseType::SET), $columns[28]->getType()->getBaseType());
